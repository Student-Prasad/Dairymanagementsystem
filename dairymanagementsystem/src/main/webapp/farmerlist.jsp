...
<div class="container">
<center><h2 style="background-color:lightblue;font-family:elephant;color:gold; padding: 5px; margin-right: 250px;
  margin-left: 250px">Farmers List</h2>
...
<tr>
	...
	<a href="crudeupdate.jsp?id=<%=rs.getInt(1) %>"> Edit</a></td>
	</tr>
	<%
