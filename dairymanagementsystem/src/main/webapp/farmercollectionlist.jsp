...
<nav class="navbar navbar-light" style="background-color: #e3f2fd;">
  ...
  <div class="collapse navbar-collapse" id="mydiv">
    ...
    <ul class="nav navbar-nav ">
      ...
      <li class="dropdown">
       <a class="dropdown-toggle" data-toggle="dropdown" href="farmercollectionlist.jsp" ><b>Collection List</b></a>
       </li>
...
<center><h2 style="font-family:elephant;background-color:lightseagreen;color:lightblue; padding:2px;margin-right: 370px;margin-left: 400px;">Collection List</h2></center>
...
ResultSet rs=st.executeQuery("select * from collection where farmercode='"+a+"' ");
while(rs.next())
{
%>
<tr>
