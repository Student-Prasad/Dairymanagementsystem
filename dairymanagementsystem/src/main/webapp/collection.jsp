...
<body>
<form action="col.jsp" method="post">
...
<center><h2 style="font-family:elephant;background-color:lightseagreen;color:lightblue; padding:2px;margin-right: 370px;margin-left: 400px;">Collection Center</h2></center>
  ...
  <div class="row">
	...
	border:2px solid red;background-color:lightsalmon">
     ...
     <div class="form-group">
          ...
          <label for="n"><center>Date</center></label>
          <input type="date"  class=form-control name="p1" required>
        </div>
         <div class="form-group">
    
    
          <label for="n"><center>Time</center></label>
          <input type="time"  class=form-control name="p2" required>
        </div>
         <div class="form-group">
       <label for="n1"><center>Farmer Code</center></label>
       ...
       %>
        ...
        <div class="form-group">
         ...
         <div class="form-group">
          ...
          <label for="n"><center>Quantity</center></label>
