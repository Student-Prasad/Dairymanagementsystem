...
<div class="container">
<center><h2 style="background-color:lightseagreen;color:lightblue;font-family:elephant; padding: 5px; margin-right: 250px;
  margin-left: 250px">Report Card</h2>
...
String j=request.getParameter("p2");
float rate;
if(j.equals("Cow"))
{
	 rate=28.50f;
...
Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/dairy","root","");
                PreparedStatement p=con.prepareStatement("select * from collection where farmercode='"+i+"' ");
              ...
              for(String l:s)
              {
            	  if(l.equals(i))
            	 {
                  PreparedStatement pc=con.prepareStatement("select * from collection where farmercode='"+i+"'");
